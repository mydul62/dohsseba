...
async function main() {
  console.log('🔄 Restoring ALL category items (Rice, Chilli, Fish, Meat, Vegetables, Bakery, Milk, Cleaning, Cosmetics, Frozen)...');
  ...
  // 2. Define top-level Categories & Subcategories from Screenshot
  const categoryDefs = [
    ...
    { name: 'ফ্রেজেন আইটেম', slug: 'frozen-items', image: 'https://images.unsplash.com/photo-1563245372-f21724e3856d?w=500&auto=format&fit=crop&q=80' },
  ...
  for (const c of categoryDefs) {
    ...
    if (cat) {
      cat = await prisma.productCategory.update({
        where: { id: cat.id },
        data: { image: c.image }
      });
    } else {
  ...
  // Create Subcategories under "রান্না ও মুদিখানা"
  const cookingMainId = catMap['cooking-grocery'];
  const subCategoryDefs = [
    { name: 'চাল, আটা ও ময়দা', slug: 'rice-flour-atta', image: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=500&auto=format&fit=crop&q=80' },
    { name: 'মসলা 🌶️', slug: 'spices', image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=500&auto=format&fit=crop&q=80' },
    { name: 'ডাল 🫘', slug: 'lentils-dal', image: 'https://images.unsplash.com/photo-1543339308-43e59d6b73a6?w=500&auto=format&fit=crop&q=80' },
    { name: 'সবজি 🥦', slug: 'vegetables', image: 'https://images.unsplash.com/photo-1619566636858-adf3ef46400b?w=500&auto=format&fit=crop&q=80' }
  ];

  for (const s of subCategoryDefs) {
    let sub = await prisma.productCategory.findFirst({
      where: { OR: [{ name: s.name }, { slug: s.slug }] }
    });
    if (sub) {
      sub = await prisma.productCategory.update({
        where: { id: sub.id },
        data: { parentId: cookingMainId, image: s.image }
      });
    } else {
      sub = await prisma.productCategory.create({
        data: { name: s.name, slug: s.slug, parentId: cookingMainId, image: s.image }
      });
    }
    catMap[s.slug] = sub.id;
    catMap[s.name] = sub.id;
  }

  // 3. Complete Product Master Dataset matching screenshot items
  const allProducts = [
    // 🌾 Rice & Flour Items
    ...
    { name: 'বসুন্ধারা আটা', slug: 'bashundhara-atta', price: 310, unit: 'kg', amount: 5, catSlug: 'rice-flour-atta', image: 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=600&auto=format&fit=crop&q=80' },
    { name: 'আকিজ আটা', slug: 'akij-atta', price: 310, unit: 'kg', amount: 5, catSlug: 'rice-flour-atta', image: 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=600&auto=format&fit=crop&q=80' },
    { name: 'সেনা আটা', slug: 'sena-atta', price: 100, unit: 'kg', amount: 2, catSlug: 'rice-flour-atta', image: 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=600&auto=format&fit=crop&q=80' },

    // 🌶️ Spices & Chilli Items
    { name: 'মরিচ গুঁড়া (Red Chilli)', slug: 'chilli-powder', price: 100, unit: 'gm', amount: 200, catSlug: 'spices', image: 'https://images.unsplash.com/photo-1599940824399-b87987ceb72a?w=600&auto=format&fit=crop&q=80' },
    { name: 'হলুদ গুঁড়া', slug: 'turmeric-powder', price: 100, unit: 'gm', amount: 200, catSlug: 'spices', image: 'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=600&auto=format&fit=crop&q=80' },
    { name: 'ধনিয়া গুঁড়া', slug: 'coriander-powder', price: 100, unit: 'gm', amount: 200, catSlug: 'spices', image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=600&auto=format&fit=crop&q=80' },
    { name: 'জিরা গুঁড়া', slug: 'cumin-powder', price: 100, unit: 'gm', amount: 200, catSlug: 'spices', image: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=600&auto=format&fit=crop&q=80' },
    ...
    // 🥦 Vegetables & Fruits
    { name: 'কাঁচা মরিচ (Green Chilli)', slug: 'green-chilli', price: 120, unit: 'kg', amount: 1, catSlug: 'vegetables', image: 'https://images.unsplash.com/photo-1599940824399-b87987ceb72a?w=600&auto=format&fit=crop&q=80' },
    { name: 'আলু (Deshi Potato)', slug: 'deshi-potato-alu', price: 40, unit: 'kg', amount: 1, catSlug: 'vegetables', image: 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=600&auto=format&fit=crop&q=80' },
    { name: 'টমেটো (Fresh Tomato)', slug: 'fresh-tomato', price: 60, unit: 'kg', amount: 1, catSlug: 'vegetables', image: 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=600&auto=format&fit=crop&q=80' },
    { name: 'পেঁয়াজ (Deshi Onion)', slug: 'deshi-onion-piaj', price: 80, unit: 'kg', amount: 1, catSlug: 'vegetables', image: 'https://images.unsplash.com/photo-1618512496248-a07fe83aa8cf?w=600&auto=format&fit=crop&q=80' },
    ...
    { name: 'খামারের খাঁটি তরল দুধ (Fresh Milk 1L)', slug: 'fresh-liquid-milk-1l', price: 90, unit: 'L', amount: 1, catSlug: 'milk', image: 'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=600&auto=format&fit=crop&q=80' },

    // 🧼 Home & Cleaning
    { name: 'হুইল পাউডার (Wheel Washing Powder)', slug: 'wheel-washing-powder', price: 120, unit: 'kg', amount: 1, catSlug: 'home-cleaning', image: 'https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=600&auto=format&fit=crop&q=80' },
    { name: 'ভিআইএম লিকুইড (Vim Liquid)', slug: 'vim-dishwash-liquid', price: 110, unit: 'ml', amount: 500, catSlug: 'home-cleaning', image: 'https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=600&auto=format&fit=crop&q=80' }
  ];

  for (const p of allProducts) {
    const categoryId = catMap[p.catSlug] || Object.values(catMap)[0];
  ...
  // Set all DB products to active & featured
  ...
  console.log(`🎉 ALL products (Rice, Chilli, Fish, Meat, Vegetables, Biscuits, Milk, Cleaning) successfully restored!`);
}
